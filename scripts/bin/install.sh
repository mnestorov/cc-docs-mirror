...
# Claude Code Docs Installer v1.0.0 - Semantic release and modernization
# This script installs/migrates claude-code-docs to ~/.claude-code-docs

echo "Claude Code Docs Installer v1.0.0"
echo "==============================="
...
echo ""
echo "Setting up Claude Code Docs v1.0.0..."
...
# Success message
echo ""
echo "✅ Claude Code Docs v1.0.0 installed successfully!"
echo ""
